...
* 이렇게 수정을 해도 실제로 작동하진 않는다.
  @WithMockUser가 MockMvc에서만 작동하기 때문이다. 현재 PostsApiControllerTest는 @SpringBootTest로만
  되어있으며 MockMvc를 전혀 사용하지 않는다. 그래서 @SpringBootTest에서 MockMvc를 사용할 수 있게 해야한다.
